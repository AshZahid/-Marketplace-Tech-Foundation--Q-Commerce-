...
export default async function OurShop() {
    ...
    const food = await sanityfetch({query: allfood})
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                {
                    food.map((items:any) => (
                       <div key={items.id} className="shadow-lg">
                        <Link href={`/dfood/${items.slug.current}`}>
                               <div className="relative">
                                  <Image src={items.imageUrl} alt="food image" width={200} height={200}/>                     
                               </div>
                               <h2 className="text-sm">{items.name}</h2>
                               <h3 className="text-sm text-yellow-500">{items.price}</h3>
                               <button className="px-3 py-1 mb-2 text-sm font-medium text-white hover:text-yellow-600 bg-yellow-600 hover:bg-white">Order Now</button>
                               </Link>
                       </div>        
                    ))
                }
    ...
    <div className="flex flex-col lg:flex-row gap-5 mt-2">
        ...
        <button className="px-3 py-1 mb-2 text-sm font-medium text-white bg-yellow-600 hover:bg-white-600">Order Now</button>
        </div>
        <div>
